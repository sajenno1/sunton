      ...
      <div class="skuBox clearfix">
        ...
        <div class="skuBox-right">
          <el-table ref="multipleTable" :data="skuList" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="productSkuName" label="全选">
            </el-table-column>
          </el-table>
...
export default {
  ...
  data () {
    return {
      ...
      no: '',
      multipleSelectSku: [],
      retData: {productName: '', price: 0, skuList: [], productId: '', no: '11'}
    }
  },
  methods: {
    open () {
    ...
    getList () {
      this.$http.post(api.productSelectList, {
    ...
    handleSelectionChange (index, row) {
      ...
      this.retData.price = this.price
      this.retData.no = this.no
      this.retData.skuList = index
      if (index.length > 0) {
        this.retData.productId = index[0].productId
      }
