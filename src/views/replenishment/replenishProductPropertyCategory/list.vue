...
export default {
  ...
  methods: {
    getList () {
      this.$http.post(api.replenishProductPropertyCategoryList, {
    ...
    handleDelete (index, row) {
      this.$confirm('确定删除该商品属性分类吗？')
        .then(() => {
          this.$http.post(api.delReplenishProductPropertyCategory, { id: row.id }).then(res => {
            this.getList()
