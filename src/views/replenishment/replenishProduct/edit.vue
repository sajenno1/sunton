...
export default {
  name: 'replenishment-replenishProduct-edit',
  data () {
    return {
      ...
      form: {},
      brandList: [],
      imgUpload: this.$http.defaults.baseURL + api.uploadPhoto,
      ue: '',
  ...
  methods: {
    async open (id) {
      ...
      _this.ue.addListener('ready', function () {
        _this.ue.setContent(_this.form.descrption || '')
      })
    },
    async getInfo (id) {
      await this.$http.post(api.replenishProductInfo, { id: id }).then(res => {
        this.form = res.data
    ...
    async getBrandList () {
      await this.$http.post(api.replenishProductBrandList, this.pageParams).then(res => {
        this.brandList = res.data.rows
      })
    },
    async getPropertyCategoryList () {
      await this.$http.post(api.replenishProductPropertyCategoryList, this.pageParams).then(res => {
    ...
    async getCategoryList () {
      await this.$http.post(api.replenishProductCategoryCascader).then(res => {
        this.categoryList = res.data
      })
    },
    async getTopCategory (id) {
      await this.$http.post(api.getReplenishTopCategory, { id: id }).then(res => {
