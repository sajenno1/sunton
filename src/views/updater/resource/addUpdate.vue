<template>
  <div>
    <el-dialog title="添加资源升级" :visible.sync="show" width="40%" append-to-body>
      <el-form :model="form" label-width="120px">
        ...
        <el-form-item label="说明">
          <el-input type="textarea" autosize v-model="form.updateDescription"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    create () {
      this.$http.post(api.addResourceUpdate, this.form).then(res => {
        this.show = false
        this.$emit('getList')
