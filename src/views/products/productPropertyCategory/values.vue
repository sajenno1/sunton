...
export default {
  name: 'products-productPropertyCategory-values',
  ...
  methods: {
    ...
    getList () {
      this.$http.post(api.getProductPropertyCategoryPropertyVaules, { id: this.row.id, isSaleProp: this.isSaleProp }).then(res => {
        this.list = res.data
