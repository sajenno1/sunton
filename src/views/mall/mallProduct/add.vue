...
export default {
  ...
  methods: {
    ...
    getBrandList () {
      this.$http.post(api.mallBrandList, this.pageParams).then(res => {
        this.brandList = res.data.rows
      })
    },
    getPropertyCategoryList () {
      this.$http.post(api.mallProductPropertyCategoryList, this.pageParams).then(res => {
    ...
    getCategoryList () {
      this.$http.post(api.mallProductCategoryCascader).then(res => {
    ...
    create () {
      ...
      alert(this.form.no)
      this.$http.post(api.addMallProduct, this.form).then(res => {
        this.$emit('getList')
        this.show = false
